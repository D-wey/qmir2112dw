...
```{r q5, echo = FALSE}
question_text("What is the coefficient for the duration of World Bank membership (`length_world`). Round the coefficient to two digits after the decimal.",
...
```{r encode, echo=FALSE}
learnrhash::encoder_ui(default_ui(url ="https://ilias.uni-mannheim.de/ilias.php?baseClass=ilObjSurveyGUI&ref_id=1114226&cmd=infoScreen"))
```